...
/* Resize */
void Java_esgi_fouriam_SDLActivity_onNativeResize(
...
// Paddown
int Java_esgi_fouriam_SDLActivity_onNativePadDown(
                                    JNIEnv* env, jclass jcls,
...
// Padup
int Java_esgi_fouriam_SDLActivity_onNativePadUp(
                                   JNIEnv* env, jclass jcls,
                                   jint device_id, jint keycode)
{
...
/* Joy */
void Java_esgi_fouriam_SDLActivity_onNativeJoy(
                                    JNIEnv* env, jclass jcls,
...
/* POV Hat */
void Java_esgi_fouriam_SDLActivity_onNativeHat(
                                    JNIEnv* env, jclass jcls,
...
int Java_esgi_fouriam_SDLActivity_nativeAddJoystick(
    JNIEnv* env, jclass jcls,
...
int Java_esgi_fouriam_SDLActivity_nativeRemoveJoystick(
...
/* Surface Created */
void Java_esgi_fouriam_SDLActivity_onNativeSurfaceChanged(JNIEnv* env, jclass jcls)
{
    SDL_WindowData *data;
...
/* Surface Destroyed */
void Java_esgi_fouriam_SDLActivity_onNativeSurfaceDestroyed(JNIEnv* env, jclass jcls)
{
...
void Java_esgi_fouriam_SDLActivity_nativeFlipBuffers(JNIEnv* env, jclass jcls)
{
    SDL_GL_SwapWindow(Android_Window);
}

/* Keydown */
void Java_esgi_fouriam_SDLActivity_onNativeKeyDown(
...
/* Keyup */
void Java_esgi_fouriam_SDLActivity_onNativeKeyUp(
                                    JNIEnv* env, jclass jcls, jint keycode)
{
...
/* Keyboard Focus Lost */
void Java_esgi_fouriam_SDLActivity_onNativeKeyboardFocusLost(
                                    JNIEnv* env, jclass jcls)
{
...
/* Touch */
void Java_esgi_fouriam_SDLActivity_onNativeTouch(
                                    JNIEnv* env, jclass jcls,
...
/* Accelerometer */
void Java_esgi_fouriam_SDLActivity_onNativeAccel(
                                    JNIEnv* env, jclass jcls,
...
/* Low memory */
void Java_esgi_fouriam_SDLActivity_nativeLowMemory(
...
/* Quit */
void Java_esgi_fouriam_SDLActivity_nativeQuit(
                                    JNIEnv* env, jclass cls)
{
...
/* Pause */
void Java_esgi_fouriam_SDLActivity_nativePause(
                                    JNIEnv* env, jclass cls)
{
...
/* Resume */
void Java_esgi_fouriam_SDLActivity_nativeResume(
                                    JNIEnv* env, jclass cls)
{
...
void Java_esgi_fouriam_SDLInputConnection_nativeCommitText(
                                    JNIEnv* env, jclass cls,
...
void Java_esgi_fouriam_SDLInputConnection_nativeSetComposingText(
                                    JNIEnv* env, jclass cls,
                                    jstring text, jint newCursorPosition)
{
    const char *utftext = (*env)->GetStringUTFChars(env, text, NULL);
